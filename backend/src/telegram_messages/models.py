...
class TelegramMessage(Base):
    ...
    message_type: Mapped[TelegramMessageType] = mapped_column(SAEnum(TelegramMessageType, name='telegram_message_type', create_type=True, values_callable=lambda x: [e.value for e in x]), nullable=False)
    content: Mapped[str] = mapped_column(Text, nullable=False, comment="Message text or caption")
    status: Mapped[TelegramMessageStatus] = mapped_column(SAEnum(TelegramMessageStatus, name='telegram_message_status', create_type=True, values_callable=lambda x: [e.value for e in x]), nullable=False, server_default=TelegramMessageStatus.SENT.value)
