...
async def get_product_candidate(product_candidate_id: int, service: ServiceDependency):
...
async def create_product_candidate(data: ProductCandidateCreate, service: ServiceDependency):
...
async def update_product_candidate(product_candidate_id: int, data: ProductCandidateUpdate, service: ServiceDependency):
...
async def delete_product_candidate(product_candidate_id: int, service: ServiceDependency):
